<scriptConfig name="LVRT_CAT3" script="VRT">
  <params>
    ...
    <param name="vrt.low_pwr_value" type="float">0.35</param>
    ...
    <param name="vrt.one_phase_value" type="string">A</param>
    <param name="das.opal.record_mode" type="string">Build-in</param>
    ...
    <param name="vrt.high_pwr_ena" type="string">Disabled</param>
    <param name="vrt.consecutive_ena" type="string">Disabled</param>
    <param name="vrt.two_phase_mode" type="string">Disabled</param>
    ...
    <param name="vrt.low_pwr_ena" type="string">Enabled</param>
    <param name="vrt.one_phase_mode" type="string">Enabled</param>
