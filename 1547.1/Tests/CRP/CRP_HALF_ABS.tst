<scriptConfig name="CRP_HALF_ABS" script="CRP">
  <params>
    <param name="crp.q_max_abs_value" type="int">-4400</param>
    <param name="crp.crp_response_time" type="float">10.0</param>
    ...
    <param name="eut_crp.v_in_min" type="int">300</param>
    <param name="eut.v_in_nom" type="int">400</param>
    <param name="eut_crp.v_in_max" type="int">500</param>
    <param name="eut.p_min" type="float">1000.0</param>
    <param name="eut.var_rated" type="float">2000.0</param>
    <param name="crp.q_max_inj_value" type="int">4400</param>
